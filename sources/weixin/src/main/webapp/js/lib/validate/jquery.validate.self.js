$(document)
		.ready(
				function() {
					...
					// 英文字母数字下划线
					jQuery.validator.addMethod("stringCode", function(value,
							element) {
						return this.optional(element)
					...
					// 必须是正数，可以为2位小数以内的浮点数
					jQuery.validator.addMethod("zFloat", function(value,
							element) {
						var decimal = /^\d+(\.\d{1,2})?$/;
						return this.optional(element) || (decimal.test(value));
					...
					// 正整数
					jQuery.validator.addMethod("zNumber", function(value,
							element) {
						var decimal = /^\d+$/;
						return this.optional(element) || (decimal.test(value));
					...
					jQuery.validator.addMethod("z31Float", function(value,
							element) {
						var decimal = /^\d{1,3}(\.\d)?$/;
						return this.optional(element) || (decimal.test(value));
					 ...
					 * 验证下拉树
					 */
					jQuery.validator.addMethod("selecttree", function(value,
							element) {
