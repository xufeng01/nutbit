...
$.fn.easyuiDialog=function(_205,_206){
if(typeof _205=="string"){
var _207=$.fn.easyuiDialog.methods[_205];
if(_207){
...
$.data(this,"dialog",{options:$.extend({},$.fn.easyuiDialog.defaults,$.fn.easyuiDialog.parseOptions(this),_205),contentPanel:_1f4(this)});
}
_1f7(this);
});
};
...
$.fn.easyuiDialog.parseOptions=function(_20c){
return $.extend({},$.fn.window.parseOptions(_20c),$.parser.parseOptions(_20c,["toolbar","buttons"]));
};
$.fn.easyuiDialog.defaults=$.extend({},$.fn.window.defaults,{title:"New Dialog",collapsible:false,minimizable:false,maximizable:false,resizable:false,toolbar:null,buttons:null});
})(jQuery);
(function($){
...
//扩展jQuery 方法
$.fn.extend({ 
    resizeDataGrid:function(id,pid,heightMargin, widthMargin) { 
