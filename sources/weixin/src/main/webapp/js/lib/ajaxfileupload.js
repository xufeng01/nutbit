(function($){
	...
	function createUploadForm(dataformid,formId,files) {
		...
		if (data) {
			for (var i in data) {
				if (data[i].name != null && data[i].value != null) {
                    alert(encodeURIComponent(data[i].value))
		...
		*/
		$("#"+dataformid+" input[type!=file]").each(function(){
			$(this).appendTo(form);
		});
		$("#"+dataformid+" textarea").each(function(){
			$(this).appendTo(form);
		});
		$("#"+dataformid+" select").each(function(){
			$(this).appendTo(form);
		});
	...
	$.ajaxFileUpload = function (s){
		...
		var dataformid=s.dataformid;
		
		var form = createUploadForm(dataformid,formId, s.files);
