    ...
    <div class="loginbody">
	    ...
	    <div class="loginbox">
	    	<form action="index" method="post">
	    		<ul>
				    <li><input name="loginname" id="loginname" type="text"  class="loginuser"  onkeypress="enterSumbit()"/></li>
				    <li><input name="password" id="password" type="password"  class="loginpwd" onkeypress="enterSumbit()"/>
