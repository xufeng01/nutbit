...
<script type="text/javascript" src="js/module/menu/menuList.js"></script>
</head>
<body>
	<div class="place">
	    <span>位置：</span>
    ...
    <div class="formbody">
	    <div style="float:left;">
	    	<ul id="ztree" class="ztree" style="height:300px;margin-top: 0px;"></ul>
	    </div>
    	<div > 
    		<input type="hidden" id="menuid" name="menuid"/>
			<ul class="seachform">
				    <li><label>&nbsp;&nbsp;&nbsp;&nbsp;菜单名称</label><input id="name" name="name" type="text" class="scinput" /></li>
				    <li><label>&nbsp;</label><input name="" id="btn_search" type="button" class="scbtn" value="查询"/></li>
			</ul>    
		</div>
		<div style="float:left;width:200px;left:5px;">
